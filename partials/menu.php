...
$linksPorPerfil = [
    'profissional' => [
        ...
        ['label' => 'Financeiro', 'href' => 'financeiro.php', 'pages' => ['financeiro.php', 'financeiro_mensal.php', 'recebimentos.php']],
    ...
    'secretaria' => [
        ...
        [
            ...
            'pages' => ['secretaria_agenda.php', 'agenda_liberacao.php', 'agenda_lista_agendamentos.php', 'agenda_relatorio_gerencial.php'],
            'children' => [
                ['label' => 'Agenda semanal', 'href' => 'secretaria_agenda.php', 'pages' => ['secretaria_agenda.php']],
                ['label' => 'Agendamentos', 'href' => 'agenda_lista_agendamentos.php', 'pages' => ['agenda_lista_agendamentos.php']],
                ['label' => 'Liberacao de agenda', 'href' => 'agenda_liberacao.php', 'pages' => ['agenda_liberacao.php']],
                ['label' => 'Relatorio gerencial', 'href' => 'agenda_relatorio_gerencial.php', 'pages' => ['agenda_relatorio_gerencial.php']],
            ],
        ],
    ...
    'desenvolvedor' => [
        ...
        ['label' => 'Profissional', 'href' => 'index.php', 'pages' => ['index.php', 'agenda_liberacao.php', 'atendimentos.php', 'novo_atendimento.php', 'editar_atendimento.php', 'guias.php', 'gestao_guias.php', 'financeiro.php', 'financeiro_mensal.php', 'recebimentos.php', 'meu_cadastro.php']],
        ['label' => 'Secretaria', 'href' => 'secretaria.php', 'pages' => ['secretaria.php', 'secretaria_agenda.php', 'agenda_liberacao.php', 'agenda_lista_agendamentos.php', 'agenda_relatorio_gerencial.php', 'secretaria_servicos.php', 'novo_servico.php', 'editar_servico.php', 'atendimentos.php', 'novo_atendimento.php', 'editar_atendimento.php', 'gestao_guias.php', 'relatorios.php']],
