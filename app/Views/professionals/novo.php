        ...
        <section class="page-hero professional-hero">
            <div class="d-flex flex-column flex-xl-row justify-content-between gap-3 align-items-xl-end">
                <div>
                    ...
                    <p>Cadastro completo de profissional com permissao de edicao de guias e vinculo de servicos.</p>
                </div>
                    ...
                    <div class="card-body">
                        <form method="POST" class="professional-form">
                                ...
                                <section class="professional-tab-panel" data-tab-panel="permissoes">
                                    <div class="professional-option-list">
                                        <label class="professional-option">
                                            <input class="form-check-input" type="checkbox" name="permite_editar_guias" id="allowGuideEditing">
                                            <span class="form-check-label">Permitir edicao de guias para este profissional</span>
                                        </label>
                                        <label class="professional-option">
                                            <input class="form-check-input" type="checkbox" name="permite_secretaria_liberar_agenda" id="allowSecretaryAvailability">
                                            ...
                                            <?php foreach ($services as $service): ?>
                                                <label class="checkbox-card">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="servicos[]" value="<?= (int) $service['id'] ?>">
                                                    ...
                                                    <input type="number" name="duracoes[<?= (int) $service['id'] ?>]" class="form-control" min="1" value="<?= (int) $service['tempo_minutos'] ?>">
                                                </label>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="professional-actions">
                                <button class="btn btn-primary px-4" name="action" value="save_professional">Salvar</button>
                            </div>
                        </form>
                    </div>
                </div>
